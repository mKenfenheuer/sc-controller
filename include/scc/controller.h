...
typedef enum SCButton {
	...
	B_DPAD_DOWN			= 0b0000000000010000000000000000000,
	B_DPAD_LEFT			= 0b0000000000001000000000000000000,
	B_DPAD_RIGHT		= 0b0000000000000100000000000000000,
	B_DPAD_UP			= 0b0000000000000010000000000000000,
...
typedef enum SDButton {
	D_RPADTOUCH			= 0b0010000000000000000000000000000,
	D_LPADTOUCH			= 0b0001000000000000000000000000000,
	D_RPADPRESS			= 0b0000100000000000000000000000000,
	D_LPADPRESS			= 0b0000010000000000000000000000000,
	D_RGRIP				= 0b0000000001000000000000000000000,
	D_BACK				= 0b0000001000000000000000000000000,
	D_LGRIP				= 0b0000000100000000000000000000000,
	D_START				= 0b0000000010000000000000000000000,
	D_C					= 0b0000000000100000000000000000000,
	D_DPAD_DOWN			= 0b0000000000010000000000000000000,
	D_DPAD_LEFT			= 0b0000000000000100000000000000000,
	D_DPAD_RIGHT		= 0b0000000000000100000000000000000,
	D_DPAD_UP			= 0b0000000000000010000000000000000,
	D_A					= 0b0000000000000001000000000000000,
	D_X					= 0b0000000000000000100000000000000,
	D_B					= 0b0000000000000000010000000000000,
	D_Y					= 0b0000000000000000001000000000000,
	D_LB				= 0b0000000000000000000100000000000,
	D_RB				= 0b0000000000000000000010000000000,
	D_LT				= 0b0000000000000000000001000000000,
	D_RT				= 0b0000000000000000000000100000000,
	// CPADTOUCH and CPADPRESS is used only on DS4 pad
	D_CPADTOUCH			= 0b0000000000000000000000000000100,
	D_CPADPRESS			= 0b0000000000000000000000000000010,
	D_STICKPRESS		= 0b1000000000000000000000000000000,
	_SDButton_padding = 0xFFFFFFFF	// uint32_t
} SDButton;
